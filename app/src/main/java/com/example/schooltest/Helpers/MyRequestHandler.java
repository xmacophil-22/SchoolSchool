...
public abstract class MyRequestHandler extends AppCompatActivity {
////////////////////////////////////////Klasse, die alle Anfragen an den Server verwaltet
    /////////////////////////////////////////Methode zum Speichern von Snippets auf dem Server
    ...
    //////////////////////////////////////standard Anfrage mit wechselbarer Methode (GET,POST...)
    ///////////////////////////////////////löst Interface callbacks aus
    public static void volleyRequest(int method, PopUp myPopUp, String postUrl, JSONObject postData, RequestQueue requestQueue, String key, final VolleyCallback callback) {
        ...
        ////////////////////////////////////////////Methode zum auslesen des Snippets (JSONObject) in eine Arraylist aus Fächern
